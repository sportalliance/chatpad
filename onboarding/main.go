...
func NewName(email string) Name {
	...
	} else if strings.Contains(email, "@perfectgym.com.au") {
		segments, ok = strings.CutSuffix(email, "@perfectgym.com.au")
	} else if strings.Contains(email, "@perfectgym.com") {
		segments, ok = strings.CutSuffix(email, "@perfectgym.com")
	}
